...
const CreateQuestions = ({ onSuccess, testID, closeModal }) => {
  ...
  const handleQuestionSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('marks', parseInt(newQuestion.marks));
      ...
      newQuestion.correct.forEach((correct, index) => {
        formData.append(`correct[${index}]`, correct);
      });
